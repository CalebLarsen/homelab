...
# WebUI is reachable at 127.0.0.1:6969 from inside this container.
#
...
URL_LOGIN="http://127.0.0.1:6969/api/v2/auth/login"
URL_PREFS="http://127.0.0.1:6969/api/v2/app/setPreferences"
...
while [ "$i" -lt 30 ]; do
  ...
  login_response="$(wget -qO- \
      ...
      --header="Referer: http://127.0.0.1:6969" \
