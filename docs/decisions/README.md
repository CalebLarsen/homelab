...
| [0004](0004-cloudflared-wildcard-dns.md) | A single wildcard CNAME routes all public subdomains |
...
| [0010](0010-locally-built-services.md) | Locally-built services are exempt from digest pinning |
